...
class error_404 extends CI_Controller{
	...
	public function index(){
		...
		$data['title'] 		 		= 'Page Not Found 404 - Gading Kostum';
		...
		if(empty($data['article'])){
			...
			if(!empty($data['article'])){
				...
				$article_created_month   = date('n',strtotime($data['article'][0]['article_created']));
				$article_created_day     = date('j',strtotime($data['article'][0]['article_created']));
				...
				$article_modified_month   = date('n',strtotime($data['article'][0]['article_modified']));
				$article_modified_day     = date('j',strtotime($data['article'][0]['article_modified']));
