								...
								<div class="row">
									<?php if(isset($rental_order) && !empty($rental_order)){
										...
										<div class="form-group">
											<div class="col-sm-3 no-padding-lr personal-information">
												<div class="form-group box-border border grey">
													<label>Name</label>
												</div>
											</div>

											<div class="col-sm-9 no-padding-lr personal-information">
												<div class="form-group box-border border">
													<p>'.$rental_order[0]['customer_name'].'</p>
												</div>
											</div>
											...
											<div class="col-sm-9 no-padding-lr personal-information">
												<div class="form-group box-border border">
													<p>'.$rental_order[0]['customer_phone'].'</p>
												</div>
											</div>
											...
											<div class="col-sm-9 no-padding-lr personal-information">
												<div class="form-group box-border border">
													<p>'.$rental_order[0]['customer_address'].'</p>
												</div>
											</div>
						...
						<div class="row">
							<div class="col-xs-12 col-print-12">
								...
								<tbody>
									<?php if(isset($rental_order) && !empty($rental_order)){
										echo '<tr>
										<td colspan="5" rowspan="3" style="vertical-align:top; width: 150px; text-align:left !important;"><p style="text-align:left !important;"><strong>Note:</strong> '.html_entity_decode($rental_order[0]['rental_note']).'</p></td>
								...
								<table class="box-information box-product">
									...
									<tbody>
										<tr>
											...
											<td class="box-border border"><input type="text" class="form-control invoice-signature" name="rental_terima_uangsewa"><p class="placeholder-signature">Petugas</p></td>
											...
											<td class="box-border border"><input type="text" class="form-control invoice-signature" name="rental_terima_uangdeposit"><p class="placeholder-signature">Petugas</p></td>
										</tr>
									</tbody>
								</table>
							</tr>
