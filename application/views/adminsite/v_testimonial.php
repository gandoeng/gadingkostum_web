    ...
    <div class="row">
              ...
              <div class="form-group">
                <div class="col-lg-2">
                  <select class="form-control" id="action">
                    ...
                    <option value="<?php echo base_url('adminsite/testimonial/publish');?>">Publish</option>
                    <option value="<?php echo base_url('adminsite/testimonial/unpublish');?>">Unpublish</option>
                    <option value="<?php echo base_url('adminsite/testimonial/multiple_delete');?>">Delete</option>
                  </select>
                </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
        <div class="box box-solid">
          ...
          <div class="box-body">
            <form id="form-side-right-action" class="form-horizontal" action="<?php echo base_url('adminsite/testimonial/form');?>">
              <input type="hidden" name="testimonial_id" value="">
              <label style="width: 100%; display:block;"><span class="required">*</span> Image</label>
              <div class="input-group">
                <input id="image" type="text" class="form-control" name="testimonial_image">
