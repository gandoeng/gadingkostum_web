    ...
    <div class="row">
              ...
              <div class="form-group">
                <div class="col-lg-2">
                  <select class="form-control" id="action">
                    ...
                    <option value="<?php echo base_url('adminsite/store_location/publish');?>">Publish</option>
                    <option value="<?php echo base_url('adminsite/store_location/unpublish');?>">Unpublish</option>
                    <option value="<?php echo base_url('adminsite/store_location/multiple_delete');?>">Delete</option>
                  </select>
                </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="box-header with-border">
          ...
          <div class="box-body">
            <form id="form-side-right-action" class="form-horizontal" action="<?php echo base_url('adminsite/store_location/form');?>">
              <div class="form-group">
                <div class="col-lg-12">
              ...
              <div class="form-group">
                <div class="col-lg-12">
                  <label><span class="required">*</span> Store Code</label>
                  <input type="text" name="category_value_text" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <div class="col-lg-12">
                  <label>Address</label>
                  <textarea style="height: 150px;" name="category_value_textarea" class="form-control"></textarea>
                </div>
              </div>

              <label>URL</label>
              <div style="margin-bottom: 15px;" class="input-group">
                <span class="input-group-addon">?store_location=</span>
