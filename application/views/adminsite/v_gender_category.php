    ...
    <div class="row">
              ...
              <div class="form-group">
                <div class="col-lg-2">
                  <select class="form-control" id="action">
                    ...
                    <option value="<?php echo base_url('adminsite/gender_category/publish');?>">Publish</option>
                    <option value="<?php echo base_url('adminsite/gender_category/unpublish');?>">Unpublish</option>
                    <option value="<?php echo base_url('adminsite/gender_category/multiple_delete');?>">Delete</option>
                  </select>
                </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
        <div class="box box-solid">
          ...
          <div class="box-body">
            <form id="form-side-right-action" class="form-horizontal" action="<?php echo base_url('adminsite/gender_category/form');?>">
              <div class="form-group">
                <div class="col-lg-12">
